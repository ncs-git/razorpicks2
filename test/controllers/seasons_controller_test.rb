...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { current: @season.current, end: @season.end, name: @season.name, start: @season.start }
    end
  ...
  test "should update season" do
    patch :update, id: @season, season: { current: @season.current, end: @season.end, name: @season.name, start: @season.start }
    assert_redirected_to season_path(assigns(:season))
  end
